...
import data_preprocessing.socio_demographic_variables as sd
...
theta_df = sd.get_age_effect(voter_centered, translated=True).pivot(
    index='party', columns='Age_Bracket', values='share')
print("\n===== theta =====\n")
print(theta_df)
